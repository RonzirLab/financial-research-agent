...
class Filing:
    ...
    def download_url(self) -> str:
        return (
            f"{SEC_ARCHIVES_BASE_URL}/{int(self.cik)}/"
...
class SecClient:
    """Small SEC API client for finding and downloading latest 10-K and 10-Q filings."""
    ...
    def get_latest_filings(
        ...
        cik = self.get_cik_for_ticker(normalized_ticker)
    ...
    def download_filing(self, filing: Filing, output_dir: Path = DEFAULT_OUTPUT_DIR) -> Path:
        ...
        destination = output_dir / filing.filename
    ...
    def download_latest_annual_and_quarterly(
        ...
        return [self.download_filing(filings[form], output_dir) for form in SUPPORTED_FORMS]
